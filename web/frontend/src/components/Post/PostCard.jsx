          ...
          <div className="flex-1 min-w-0">
            ...
            {post.category && (
              <Link
                ...
                className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium mb-2 border shadow-sm transition-all duration-200 hover:brightness-110"
                style={{
